package com.lfork.blogsystem.login
...
import com.lfork.blogsystem.main.MainActivity.Companion.startMainActivity
...
class LoginActivity : BaseActivity(), LoaderCallbacks<Cursor> {
    ...
    companion object {
         ...
         */
        private val DUMMY_CREDENTIALS = arrayOf("foo@example.com:hello", "bar@example.com:world","admin@lfork.com:abc123456")
    }
}
